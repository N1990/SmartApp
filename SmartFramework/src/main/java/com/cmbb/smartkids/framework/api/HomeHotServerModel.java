 ...
 * 创建时间：15/9/16 下午5:11
 */
public class HomeHotServerModel implements Parcelable {
    ...
    public HomeHotServerModel() {
    }

    protected HomeHotServerModel(Parcel in) {
        this.data = in.readParcelable(DataEntity.class.getClassLoader());
        this.msg = in.readString();
    }

    public static final Creator<HomeHotServerModel> CREATOR = new Creator<HomeHotServerModel>() {
        public HomeHotServerModel createFromParcel(Parcel source) {
            return new HomeHotServerModel(source);
        }

        public HomeHotServerModel[] newArray(int size) {
            return new HomeHotServerModel[size];
        }
    };
     ...
     */
    public static void getHomeHotServiceRequest(int numberOfPerPage, int pageNo, OkHttpClientManager.ResultCallback<HomeHotServerModel> callback) {
