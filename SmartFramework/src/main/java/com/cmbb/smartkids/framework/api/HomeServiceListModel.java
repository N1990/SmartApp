 ...
 */
public class HomeServiceListModel implements Parcelable {
    ...
    public HomeServiceListModel() {
    }

    protected HomeServiceListModel(Parcel in) {
        this.data = in.readParcelable(DataEntity.class.getClassLoader());
        this.msg = in.readString();
    }

    public static final Creator<HomeServiceListModel> CREATOR = new Creator<HomeServiceListModel>() {
        public HomeServiceListModel createFromParcel(Parcel source) {
            return new HomeServiceListModel(source);
        }

        public HomeServiceListModel[] newArray(int size) {
            return new HomeServiceListModel[size];
        }
    };
     ...
     */
    public static void getHomeAllServiceListRequest(int city, int type, int status, int pageNo, int numberOfPerPage, OkHttpClientManager.ResultCallback<HomeServiceListModel> callback) {
        ...
        OkHttpClientManager.postAsyn(Api.HOME_GET_PAGE, params, callback);
    }
}
