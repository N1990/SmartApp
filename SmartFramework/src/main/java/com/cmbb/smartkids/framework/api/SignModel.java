...
public class SignModel implements Parcelable {
     ...
     */
    public static void getSignRequest(String token, OkHttpClientManager.ResultCallback<SignModel> callback) {
        HashMap<String, String> params = new HashMap<>();
        params.put("token", token);
        OkHttpClientManager.postAsyn(Api.SIGN_ARRIVE_REQUEST, params, callback);
    }
}
