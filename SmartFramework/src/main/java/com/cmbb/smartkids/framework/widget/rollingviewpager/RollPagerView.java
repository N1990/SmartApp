package com.cmbb.smartkids.framework.widget.rollingviewpager;
...
import com.cmbb.smartkids.framework.widget.rollingviewpager.hintview.ColorPointHintView;
...
public class RollPagerView extends RelativeLayout implements OnPageChangeListener {
    ...
    private void initView(AttributeSet attrs) {
        ...
        paddingBottom = (int) type.getDimension(R.styleable.RollViewPager_rollviewpager_hint_paddingBottom, TDevice.dip2px(4, getContext()));
