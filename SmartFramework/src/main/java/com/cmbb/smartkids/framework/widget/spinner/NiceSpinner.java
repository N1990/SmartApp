...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.half_global_padding);

        setPadding(resources.getDimensionPixelSize(R.dimen.half_global_padding), defaultPadding, defaultPadding,
                defaultPadding);
        setClickable(true);
//        setBackgroundResource(R.drawable.selector);
        ...
        mLeftDrawable = typedArray.getBoolean(R.styleable.NiceSpinner_hideLeftDrawable, false);
        mLeftRes = typedArray.getResourceId(R.styleable.NiceSpinner_leftDrawable, R.mipmap.ic_launcher);

        Drawable left = getResources().getDrawable(mLeftRes);
        if (!mHideArrow) {
            ...
            setCompoundDrawablesWithIntrinsicBounds(!mLeftDrawable ? left : null, null, mDrawable, null);
            setCompoundDrawablePadding(resources.getDimensionPixelSize(R.dimen.global_padding));
        }
