...
public class TopicListOneFragment extends TopicBaseFragment {
    ...
    public TopicListOneFragment() {
        // Required empty public constructor
    }

    public static TopicListOneFragment newInstance(Parcelable data) {
        TopicListOneFragment fragment = new TopicListOneFragment();
    ...
    private void addListener() {
        prt.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<RecyclerView>() {
            ...
            public void onPullDownToRefresh(final PullToRefreshBase<RecyclerView> refreshView) {
                Log.e("Pull", "onPullDownToRefresh");
                if (mListener != null)
